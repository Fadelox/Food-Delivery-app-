...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.viewholder> {
    ...
    public CartAdapter(ArrayList<Foods> list, CartActivity context, ChangeNumberItemsListener changeNumberItemsListener) {
        this.list = list;
    ...
    public class viewholder extends RecyclerView.ViewHolder{
        ...
        public viewholder(@NonNull View itemView) {
            ...
            feeEachItem = itemView.findViewById(R.id.feeEachltem);
            plusItem = itemView.findViewById(R.id.plusCartBtn);
            minusItem = itemView.findViewById(R.id.minusCartBtn);
            totalEachItem = itemView.findViewById(R.id.totalEachltem);
            num = itemView.findViewById(R.id.numberltemTxt);
